...
if(class_exists( 'WP_Customize_control')):
	/**
	  * Multiple Check
	*/
    class AppZend_Multiple_Check_Control extends WP_Customize_Control {
    ...
    */
    class AppZend_Switch_Control extends WP_Customize_Control{
...
*/
if(!function_exists('appzend_awesome_icon_array') ){

	function appzend_awesome_icon_array(){
...
// Upgrade Text
if ( class_exists( 'WP_Customize_Control' ) ) {
	if ( !class_exists( 'AppZend_Upgrade_Text' ) ) {
		class AppZend_Upgrade_Text extends WP_Customize_Control {

	        public $type = 'appzend-upgrade-text';
	        ...
	        public function render_content() {
	            ...
	            <label>
	                ...
	                <a href="<?php echo esc_url('https://sparklewpthemes.com/wordpress-themes/appzend-multipurpose-business-theme/'); ?>" target="_blank"> <strong><?php echo esc_html__('Upgrade to PRO', 'appzend'); ?></strong></a>
	            </label>
